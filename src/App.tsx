...
import ServiceCarpentry from "./pages/services/Carpentry";
import ServicePainting from "./pages/services/Painting";
import ServiceRenovation from "./pages/services/Renovation";
